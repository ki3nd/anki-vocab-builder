...
```
uv run .claude/commands/fetch_word.py "<compound noun>" noun
```
...
- **ipa** — `pronunciations[0].text`; if `pronunciations` is empty, generate IPA yourself (General American preferred, transcribe both words)
