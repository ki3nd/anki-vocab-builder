...
└── .claude/
    ...
    │   ├── fetch_word.py                      # Bundled API fetch script (self-contained)
    │   ├── extract-study-files.md
    │   ├── build-vocab-table.md
    │   ├── build-phrasal-verbs-table.md
    │   ├── build-compound-nouns-table.md
    │   └── build-sentence-structures-table.md
    └── skills/                                # Agent skills (auto-triggered by context)
        ├── extract-study-files/SKILL.md
        ├── build-vocab-table/SKILL.md
        ├── build-phrasal-verbs-table/SKILL.md
        ├── build-compound-nouns-table/SKILL.md
        └── build-sentence-structures-table/SKILL.md
```
...
- `.claude/commands/fetch_word.py` — bundled copy used by all Claude commands (self-contained)
...
Skills are auto-triggered by context — Claude invokes them when the task matches without needing an explicit command.

| Skill | Trigger |
|-------|---------|
| `extract-study-files` | New reading text provided, or `output/` is empty/missing |
| `build-vocab-table` | `output/vocabulary.md` ready, `tables/vocabulary.md` missing or incomplete |
| `build-phrasal-verbs-table` | `output/phrasal_verbs.md` ready, `tables/phrasal_verbs.md` missing or incomplete |
| `build-compound-nouns-table` | `output/compound_nouns.md` ready, `tables/compound_nouns.md` missing or incomplete |
| `build-sentence-structures-table` | `output/sentence_structures.md` ready, `tables/sentence_structures.md` missing or incomplete |
...
**Important:** This command processes words one at a time and writes each row immediately — do not batch or defer writes.
...
**Note:** Many compound nouns are not in the API. The fallback (self-generated definition, ipa, examples) will be used frequently for this command.
